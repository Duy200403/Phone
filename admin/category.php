...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="category.php"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Quản lý danh mục</a></li>
							...
							<div class="panel-body">
								<table 
									...
									<tbody>
										...
										?>
										<tr>
											<td style=""><?php echo $cate['cate_id'] ?></td>
											<td style=""><?php echo $cate['cate_name'] ?></td>
											<td class="form-group">
											<a href="edit_category.php?cate_id=<?php echo $cate['cate_id'] ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
											<a href="remove_cate.php?cate_id=<?php echo $cate['cate_id']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
											</td>
										</tr>
										<?php
											}	
